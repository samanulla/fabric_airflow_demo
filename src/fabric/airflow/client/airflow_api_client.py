import datetime
from fabric.airflow.client.base_api_client import AuthenticationProvider, ApiResponse, BaseApiClient
...
class AirflowApiClient(BaseApiClient):
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        Args:
            ...
            **kwargs: Additional arguments passed to BaseApiClient (debug, timeout, etc.)
        """
        # Airflow native API doesn't use preview mode, set default if not provided
        kwargs.setdefault('is_preview_enabled', False)
